<?php
/**
 * Template Name: SIPORTS - Dashboard Admin
 */
            ...
            <aside class="dashboard-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <a href="#visitors" class="nav-item">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5"/></svg>
                        Visiteurs
                    </a>
                    <a href="#events" class="nav-item">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18"/></svg>
                        Événements
                    </a>
            ...
            <main class="dashboard-content">
                <div class="dashboard-header">
                    <div>
                        ...
                        <p>Gestion complète de SIPORT 2026</p>
                    </div>
                </div>

                <div class="dashboard-app">
                    <?php echo do_shortcode('[siports_admin_dashboard show_all="true"]'); ?>
                </div>
            </main>
        </div>
    </div>
