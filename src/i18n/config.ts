...
const resources = {
  ...
  // ===== BATCH 3 - 20 FILES / 196 KEYS (NewsPage, NetworkingPage, ForgotPassword, Payment, Partner*) =====
  pages: {
    news: {
      min_read: 'min de lecture',
      header_title: 'Actualités & Innovations SIPORTS',
      header_desc: 'Restez informé des dernières innovations portuaires et technologies numériques',
      official_source: 'Source Officielle',
      search_placeholder: 'Rechercher une actualité...',
      filters_btn: 'Filtres',
      refresh_btn: 'Actualiser',
      sync_success: '✅ Synchronisation réussie avec le site officiel',
      sync_error: '❌ Erreur de synchronisation',
      category_event: 'Événement',
      category_innovation: 'Innovation',
      category_partnership: 'Partenariat'
    },
    networking: {
      premium_required: 'Fonctionnalité Premium',
      recommendations_title: 'Recommandations Intelligentes',
      generating_ai: 'Génération IA en cours...',
      recommendations_ready: 'Recommandations prêtes',
      search_results: 'Résultats de recherche',
      profiles_found: 'profils trouvés',
      search_error: 'Erreur lors de la recherche',
      quota_loading: 'Chargement de la quota...',
      siports_2026: 'SIPORTS 2026',
      professionals: 'professionnels',
      tab_recommendations: 'Recommandations',
      tab_search: 'Recherche',
      tab_messages: 'Messages',
      appointment_booking: 'Réservation de rendez-vous',
      appointment_modal: 'Modal Rendez-vous',
      premium_title: 'Accès Premium Requis',
      free_pass_desc: 'La passe gratuite ne vous donne accès qu\'aux fonctionnalités de base',
      upgrade_benefits_1: 'Recommandations IA illimitées',
      upgrade_benefits_2: 'Accès à tous les professionnels',
      upgrade_benefits_3: 'Messagerie directe prioritaire',
      upgrade_benefits_4: '10 rendez-vous garantis',
      upgrade_button: 'Passer à Premium',
      limited_mode: 'Mode Limité',
      login_required: 'Connexion requise',
      login_desc: 'Connectez-vous pour voir les professionnels',
    ...
    forgot_password: {
      ...
      sending: 'Envoi en cours...',
      email_required_validation: 'Veuillez entrer votre email',
      email_invalid_validation: 'Email invalide'
    },
    forbidden: {
      error_403: 'Erreur 403',
      error_403_desc: 'Accès interdit. Vous n\'avez pas les permissions requises.',
      back_dashboard: 'Retour au tableau de bord'
    },
    demo: {
      quick_accounts: 'Comptes de Démonstration Rapides',
      click_to_login: 'Cliquez pour vous connecter',
      toggle_passwords: 'Afficher/Masquer les mots de passe',
      hide_passwords: 'Masquer les mots de passe',
      visitor_free: 'Visiteur Gratuit',
      visitor_vip: 'Visiteur Premium',
      exhibitor_9m: 'Exposant 9m²',
      exhibitor_18m: 'Exposant 18m²',
      exhibitor_36m: 'Exposant 36m²',
      partner_demo: 'Partenaire Premium',
      marketing_admin: 'Admin Marketing',
      admin_role: 'Rôle: Administrateur',
      login_success: 'Connexion de démonstration réussie',
      login_error: 'Erreur lors de la connexion'
    },
    payment: {
      title: 'Paiement de l\'abonnement',
      already_vip: 'Vous êtes déjà Premium',
      password_min: 'Minimum 12 caractères',
      password_uppercase: 'Au moins 1 majuscule',
      password_lowercase: 'Au moins 1 minuscule',
      password_number: 'Au moins 1 chiffre',
      password_special: 'Au moins 1 caractère spécial',
      password_mismatch: 'Les mots de passe ne correspondent pas',
      stripe_error: 'Erreur de paiement Stripe',
      paypal_error: 'Erreur de paiement PayPal',
      cmi_error: 'Erreur de paiement CMI',
      stripe_button: 'Payer avec Stripe',
      paypal_button: 'Payer avec PayPal',
      cmi_button: 'Payer avec CMI',
      success_text: '✅ Paiement réussi !',
      processing: 'Traitement en cours...'
    },
    minisite_creation: {
      create_title: 'Créer mon mini-site',
      wizard_header: 'Assistant de création'
    },
    minisite_list: {
      list_title: 'Mes mini-sites',
      list_subtitle: 'Gérez vos mini-sites personnalisés',
      available_count: 'mini-sites disponibles',
      search_placeholder: 'Rechercher un mini-site...',
      no_results: 'Aucun mini-site',
      no_results_search: 'Aucun résultat pour votre recherche',
      no_results_empty: 'Créez votre premier mini-site',
      loading: 'Chargement...',
      view_button: 'Voir',
      views_count: 'vues'
    },
    partner: {
      media_upload: {
        submit_title: 'Soumettre un média',
        submit_subtitle: 'Webinar, podcast, capsule ou contenu en direct',
        validation_required: 'Validation requise',
        validation_text: 'Votre média passera par une validation avant publication',
        media_type: 'Type de média',
        webinar: 'Webinaire',
        podcast: 'Podcast',
        capsule: 'Capsule Inside',
        live: 'En Direct',
        title: 'Titre',
        description: 'Description',
        category: 'Catégorie',
        url: 'Lien vers le média'
      },
      networking: {
        opportunities_title: 'Opportunités de Partenariat',
        ...
        message_button: 'Envoyer un message',
      ...
      profile_edit: {
        ...
        basic_section: 'Informations de base',
        company_name: 'Nom de l\'entreprise',
        description: 'Description',
      ...
      support: {
        ...
        resolved_month: 'Résolus ce mois',
        ...
        administrative: 'Support administratif',
        create_ticket: 'Créer un ticket',
        contact_support: 'Contacter le support'
      },
      media_analytics: {
        title: 'Analytiques des Médias',
        follow_performances: 'Suivez les performances de vos médias',
        total_views: 'Vues totales',
        total_likes: 'Mentions j\'aime',
        total_shares: 'Partages',
        avg_duration: 'Durée moyenne de visionnage',
      ...
      leads: {
        ...
        conversion_rate: 'Taux de conversion',
        type_exhibitor: 'Type: Exposant',
        type_visitor: 'Type: Visiteur',
        connected: 'Connecté',
        pending: 'En attente',
        rejected: 'Rejeté',
        active_followup: 'Suivi actif',
        awaiting_response: 'En attente de réponse',
        sources_events: 'Source: Événements',
        sources_networking: 'Source: Réseautage',
        sources_referrals: 'Source: Références',
        funnel_generated: 'Entonnoir: Générés',
        funnel_qualified: 'Entonnoir: Qualifiés'
      },
      events: {
        title: 'Événements Partenaires',
        subtitle: 'Programme des événements',
        program: 'Programme',
      ...
      analytics: {
        ...
        subtitle: 'Performance ROI et données temps réel',
        export_button: 'Exporter rapport PDF',
        period_7d: 'Derniers 7 jours',
        period_30d: 'Derniers 30 jours',
        period_90d: 'Derniers 90 jours',
        period_1y: 'Dernière année',
        profile_views: 'Vues du profil',
        connections: 'Connexions établies',
        leads_generated: 'Leads générés',
        roi: 'ROI estimé',
        real_time_data: 'Données temps réel',
