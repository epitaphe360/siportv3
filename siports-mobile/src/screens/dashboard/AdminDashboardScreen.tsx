  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>Administration SIPORTS 2026</Text>
        <Text style={styles.subtitle}>Bienvenue, {user?.name}</Text>
      </View>
      <View style={styles.card}>
        <Text style={styles.cardTitle}>📊 Métriques Générales</Text>
        <Text style={styles.cardText}>Vue d'ensemble de la plateforme</Text>
      </View>
    </ScrollView>
  );
}
